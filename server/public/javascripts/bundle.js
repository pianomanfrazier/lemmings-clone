...
},{"./js/GameLoop.js":2,"./js/Sprite.js":5,"./js/lib/inputs":6,"./js/views/highscores.hbs":11,"./js/views/index.hbs":12,"jquery":35,"lodash":36,"page":37}],2:[function(require,module,exports){
...
},{"./Globals.js":3,"./Graphics.js":4}],3:[function(require,module,exports){
let Graphics = require("./Graphics.js");
...
},{"./Graphics.js":4}],4:[function(require,module,exports){
...
},{"./Globals.js":3}],6:[function(require,module,exports){
var _ = require('lodash');
...
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div id=\"GameScreen\">\n"
    ...
    + "<div id=\"game-field\">\n    <div id=\"game-screen\">\n        <canvas id=\"canvas\"></canvas>\n        <canvas id=\"mini-map\"></canvas>\n    </div>\n    <div id=\"status-bar\">\n        <div id=\"timer\">\n            Time : 00:00\n        </div>\n        <div id=\"out\">\n            OUT : 22\n        </div>\n        <div id=\"in\">\n            IN : 0%\n        </div>\n    </div>\n    <div id=\"control-panel\">\n        <ul>\n            <li>\n                <button class=\"bump\" id=\"pause-btn\" onclick=\"inputs.Keyboard.buttonPress('pause-btn')\"></button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"atomic-bombs-btn\" onclick=\"inputs.Keyboard.buttonPress('atomic-bombs-btn')\"></button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"btn3\" onclick=\"inputs.Keyboard.buttonPress('btn3')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump active\" id=\"pick-axe-btn\" onclick=\"inputs.Keyboard.buttonPress('pick-axe-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-digging-btn\" onclick=\"inputs.Keyboard.buttonPress('lemming-digging-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-builder-btn\" onclick=\"inputs.Keyboard.buttonPress('lemming-builder-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-blocking-btn\" onclick=\"inputs.Keyboard.buttonPress('lemming-blocking-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-exploding-btn\" onclick=\"inputs.Keyboard.buttonPress('lemming-exploding-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-umbrella-btn\" onclick=\"inputs.Keyboard.buttonPress('lemming-umbrella-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"lemming-climbing-btn\" onclick= \"inputs.Keyboard.buttonPress('lemming-climbing-btn')\">\n                    <div class=\"status\">\n                        123\n                    </div>\n                </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"speed-up-btn\" onclick=\"inputs.Keyboard.buttonPress('speed-up-btn')\">\n                    <div class=\"status\">\n                        50\n                    </div>\n                 </button>\n            </li>\n            <li>\n                <button class=\"bump\" id=\"speed-down-btn\" onclick=\"inputs.Keyboard.buttonPress('speed-down-btn')\">\n                    <div class=\"status\">\n                        50\n                    </div>\n                </button>\n            </li>\n        </ul>\n    </div>\n</div>\n<script src=\"/javascripts/bundle.js\"></script>\n\n</div>\n";
},"usePartial":true,"useData":true});
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <ol>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.highscores : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </ol>\n";
  ...
  return ((stack1 = container.invokePartial(partials["./_return.hbs"],depth0,{"name":"./_return.hbs","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    ...
    + "</h1>\n\n"
    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.highscores : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(4, data, 0),"data":data})) != null ? stack1 : "")
    + "</div>\n";
},"usePartial":true,"useData":true});
...
},{"_process":39,"path-to-regexp":38}],38:[function(require,module,exports){
